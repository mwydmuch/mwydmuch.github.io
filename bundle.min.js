...
Coded by me (Marek Wydmuch) in 2024.
`)}}e.exports=s},{"../threejs-shader-animation":43}],39:[function(t,e,i){t=t("../shader-animation");class s extends t{constructor(t,e,i,s){super(t,e,i,s,`
    precision mediump float;
...
`)}}e.exports=s},{"../shader-animation":37}],40:[function(t,e,i){t=t("./animation");class s extends t{constructor(t,e,i,s,a="",r="",n="",o="random"){super(t,e,i,s,a,r,n,o,"webgl"),this.renderer=new THREE.WebGLRenderer({antialias:!0,canvas:t}),this.renderer.setSize(t.width,t.height),this.scene=new THREE.Scene,this.scene.background=new THREE.Color(s),this.camera=new THREE.PerspectiveCamera(75,t.width/t.height,1,1e3)}update(t){super.update(t)}draw(){this.renderer.render(this.scene,this.camera)}clear(){this.renderer&&(this.renderer.setClearColor(this.bgColor,1),this.renderer.clear(!0,!0,!0))}resize(){super.resize();var t=this.canvas.width,e=this.canvas.height;this.renderer.setSize(t,e),this.camera.aspect=t/e,this.camera.updateProjectionMatrix()}updateColors(t,e,i){super.updateColors(t,e,i),this.scene.background=new THREE.Color(i)}getCodeUrl(){return"https://github.com/mwydmuch/mwydmuch.github.io/blob/master/js/threejs-animations"+this.file}}e.exports=s},{"./animation":2}],41:[function(t,e,i){t=t("../animations/gradient-descent");let s=Math.PI/2-.08;class a extends t{constructor(t,e,i,s,a="random",r=1,n=5,o=!0,h=1e3){super(t,e,i,s,a,r,n,o,h,null),this.name="3D visualization of gradient descent algorithms",this.file="gradient-descent.js",this.description=`
