...
Coded with no external dependencies, using only canvas API.
`),this.charSize=a,this.lineX=this.padding,this.lineY=this.padding,this.tabSize=r,this.maxLines=0,this.line=0,this.tabs=0,this.words=0,this.wordLen=0,this.editorTheme={keyword:"#33C5E1",typeName:"#F52D73",argument:"#F9A857",variable:"#030303",numericValue:"#B693FB",stringValue:"#F0763B",comment:"#737373"},this.firstWordColors=[this.editorTheme.keyword,this.editorTheme.typeName,this.editorTheme.variable,this.editorTheme.comment],this.afterTypeName=[this.editorTheme.argument,this.editorTheme.typeName,this.editorTheme.variable],this.afterVariable=n.getValues(this.editorTheme),this.otherCases=[this.editorTheme.keyword,this.editorTheme.typeName,this.editorTheme.variable,this.editorTheme.comment,this.editorTheme.numericValue,this.editorTheme.stringValue],this.currentColor=null,this.imageData=null,this.updateCharSize(),this.newLine(),this.newWord()}updateCharSize(){this.padding=this.charSize/2,this.lineHeight=1.25*this.charSize,this.charWidth=Math.ceil(this.charSize/1.618),this.charHeight=this.charSize,this.imageData=null,this.line=0,this.resize(),this.newWord()}newWord(){(this.wordLen=0)===this.words?this.currentColor=n.randomChoice(this.firstWordColors):this.currentColor===this.editorTheme.typeName?this.currentColor=n.randomChoice(this.afterTypeName):this.currentColor===this.editorTheme.variable?this.currentColor=n.randomChoice(this.afterVariable):this.currentColor===this.editorTheme.comment?this.currentColor=this.editorTheme.comment:this.currentColor=n.randomChoice(this.otherCases)}newLine(){var t;this.line>this.maxLines&&(t=(this.maxLines-this.line)*this.lineHeight,this.clear(),null!==this.imageData&&this.ctx.putImageData(this.imageData,0,t),this.line=this.maxLines),this.words=0,this.lineX=this.padding+this.tabs*this.tabSize*this.charWidth,this.lineY=this.padding+this.line*this.lineHeight}draw(){var t;this.rand()<Math.pow(.9,this.wordLen-2)||this.wordLen<3?(this.lineX+=this.charWidth,++this.wordLen,this.ctx.fillStyle=this.currentColor,this.ctx.fillRect(this.lineX,this.lineY,this.charWidth,this.charHeight)):(this.rand()<Math.pow(.5,this.words-1)||this.words<2?(++this.words,this.lineX+=this.charWidth):("inc"===(t=n.randomChoice(["inc","inc","dec","dec","keep","keep","reset","keep+newline"]))&&this.tabs<4?++this.tabs:"keep+newline"===t?++this.line:"dec"===t&&0<this.tabs?(++this.line,--this.tabs):"reset"===t&&0<this.tabs&&(++this.line,this.tabs=0),++this.line,this.newLine()),this.newWord()),this.imageData=this.ctx.getImageData(0,0,this.ctx.canvas.width,this.ctx.canvas.height)}resize(){this.clear(),null!==this.imageData&&this.ctx.putImageData(this.imageData,0,0),this.maxLines=Math.floor((this.ctx.canvas.height-2*this.padding)/this.lineHeight)-1,this.newLine()}getSettings(){return[{prop:"charSize",type:"int",min:8,max:72,toCall:"updateCharSize"},{prop:"tabSize",type:"int",min:1,max:16}]}}e.exports=a},{"../animation":2,"../utils":36}],8:[function(t,e,i){t=t("./game-of-life");class s extends t{constructor(t,e,i,s,a=12,r=1,n=.5,h=!0,o="random",l=5){super(t,e,i,s,a,r,n,h,o,l),this.name="day and night automata",this.file="day-and-night-automata.js",this.description=`
...
Coded with no external dependencies, using only canvas API.
`}update(t){++this.frame;for(let e=0;e<this.gridHeight;++e)for(let t=0;t<this.gridWidth;++t){var i=this.numAliveInMooreNeighborhood(t,e),s=this.getIdx(t,e);this.grid[s]<=0&&[3,6,7,8].includes(i)||1<=this.grid[s]&&[3,4,6,7,8].includes(i)?this.gridNext[s]=1:this.gridNext[s]=this.grid[s]-1}[this.grid,this.gridNext]=[this.gridNext,this.grid]}}e.exports=s},{"./game-of-life":10}],9:[function(t,e,i){var s=t("./game-of-life");let p=t("../utils");class a extends s{constructor(t,e,i,s,a=14,r=0,n=.4,h=!0,o=!0,l=!0,c=.75){super(t,e,i,s,a,r,n,l),this.name="isometric Conway's game of life",this.file="game-of-life-isometric.js",this.description=`
...
Coded with no external dependencies, using only canvas API.
`,this.fadeDeadCells=h,this.drawCellsGrid=o,this.gridSize=c,this.sqrt3=Math.sqrt(3),this.xShift=this.cellSize*this.sqrt3/2,this.yShift=this.cellSize/2,this.renderedGrid=null,this.renderedCubes=[];var d=p.createOffscreenCanvas(4*this.xShift,4*this.yShift).getContext("2d");this.drawIsoCube(d,0,3*this.yShift,!0,!0,this.colors,0,this.cellSize),this.renderedCubes.push(d.canvas);for(let t=1;t<this.cellSize;++t)d=p.createOffscreenCanvas(4*this.xShift,4*this.yShift).getContext("2d"),this.drawIsoCube(d,0,3*this.yShift,!0,!0,this.colorsAlt,-t,this.cellSize),this.renderedCubes.push(d.canvas)}drawIsoCube(t,e,i,s,a,r,n,h){var o=h*this.sqrt3/2,h=h/2;n*=-1,t.strokeStyle=r[0],t.fillStyle=r[3],t.beginPath(),p.pathClosedShape(t,[[e,i-2*h+n],[e+o,i-h+n],[e+2*o,i-2*h+n],[e+o,i-3*h+n]]),t.fill(),t.stroke(),s&&(t.fillStyle=r[2],t.beginPath(),p.pathClosedShape(t,[[e,i],[e+o,i+h],[e+o,i-h+n],[e,i-2*h+n]]),t.fill(),t.stroke()),a&&(t.fillStyle=r[1],t.beginPath(),p.pathClosedShape(t,[[e+o,i+h],[e+2*o,i],[e+2*o,i-2*h+n],[e+o,i-h+n]]),t.fill(),t.stroke())}drawCube(t,e,i,s=0,a=0){var r=t*this.xShift-e*this.xShift,n=(t+e+1)*this.yShift;this.drawIsoCube(this.ctx,r,n,!this.isAlive(t,e+1),!this.isAlive(t+1,e),i,s,this.cellSize-2*a)}drawGrid(s,t,e){var a=this.gridHeight*-this.xShift,r=this.gridHeight*this.yShift,n=this.gridWidth*this.xShift,h=this.gridWidth*this.yShift,i=(-this.gridHeight+this.gridWidth)*this.xShift,o=(this.gridHeight+this.gridWidth)*this.yShift,l=this.colors[0];for(let i=0;i<this.gridHeight;++i){let t=i*-this.xShift,e=i*this.yShift;p.drawLine(s,t,e,t+n,e+h,1,l),p.drawLine(s,-t,e,-t+a,e+r,1,l)}p.drawLine(s,0,0,n,h,3,l),p.drawLine(s,0,0,a,r,3,l),p.drawLine(s,a,r,i,o,3,l),p.drawLine(s,n,h,i,o,3,l)}drawPrerenderedCube(t,e,i){var s=t*this.xShift-e*this.xShift,t=(t+e+1)*this.yShift;this.ctx.drawImage(this.renderedCubes[i],s-+this.xShift,t-3*this.yShift)}mouseCellCord(t,e){}draw(){var t;this.clear(),this.drawCellsGrid&&(this.renderedGrid||((t=p.createOffscreenCanvas(this.ctx.canvas.width,this.ctx.canvas.height).getContext("2d")).translate(this.ctx.canvas.width/2,(1-this.gridSize)/2*this.ctx.canvas.height),this.drawGrid(t,0,0),this.renderedGrid=t.canvas),this.ctx.drawImage(this.renderedGrid,0,0)),this.ctx.translate(this.ctx.canvas.width/2,(1-this.gridSize)/2*this.ctx.canvas.height);for(let e=0;e<this.gridHeight;++e)for(let t=0;t<this.gridWidth;++t){var i=this.getVal(t,e);this.fadeDeadCells&&i>-(this.cellSize-2*this.cellBasePadding)?this.drawPrerenderedCube(t,e,Math.max(0,-i)):0<i&&this.drawPrerenderedCube(t,e,0)}this.ctx.resetTransform()}resize(){var t=Math.min(this.ctx.canvas.width,this.ctx.canvas.height),t=Math.ceil(this.gridSize*t/this.cellSize);this.resizeGrid(t,t),this.renderedGrid=null}getSettings(){return[{prop:"loopGrid",type:"bool"},{prop:"fadeDeadCells",type:"bool"},{prop:"drawCellsGrid",type:"bool"},{prop:"gridSize",type:"float",step:.01,min:0,max:2,toCall:"resize"},{prop:"spawnProb",type:"float",step:.01,min:0,max:1,toCall:"restart"},this.getSeedSettings()]}}e.exports=a},{"../utils":36,"./game-of-life":10}],10:[function(t,e,i){var s=t("../grid-animation");let d=t("../utils");class a extends s{constructor(t,e,i,s,a=12,r=1,n=.4,h=!0,o="random",l=5,c="size+color"){super(t,e,i,s,"Conway's game of life","game-of-life.js",`
...
`),this.particlesDensity=a,this.fillTriangles=r,this.drawParticles=n,this.distanceThreshold=h,this.width=0,this.height=0,this.particles=[],this.mouseDown=!1,this.mouseParticle={x:0,y:0,color:null}}drawTriangle(t,e,i){var s=Math.max(n.distVec2d(t,e),n.distVec2d(t,e),n.distVec2d(e,i));s>this.distanceThreshold||(this.ctx.beginPath(),n.pathClosedShape(this.ctx,[t,e,i]),e=n.lerpColor(t.color,this.bgColor,n.easeInSine(s/this.distanceThreshold)),this.fillTriangles?(this.ctx.fillStyle=e,this.ctx.fill()):(this.ctx.lineWidth=1,this.ctx.strokeStyle=e,this.ctx.stroke()))}update(t){super.update(t);for(var e of this.particles)e.x+=e.velX*t*this.speed,e.y+=e.velY*t*this.speed,(e.x<0||e.x>this.width)&&(e.velX*=-1),(e.y<0||e.y>this.height)&&(e.velY*=-1)}draw(){if(this.clear(),this.mouseDown&&this.particles.push(this.mouseParticle),0<this.particles.length){var e=r.triangulate(this.particles.map(function(t){return[t.x,t.y]}));for(let t=0;t<e.length;t+=3){var i=this.particles[e[t]],s=this.particles[e[t+1]],a=this.particles[e[t+2]];this.drawTriangle(i,s,a)}}if(this.drawParticles)for(var t of this.particles)n.fillCircle(this.ctx,t.x,t.y,2,t.color);this.mouseDown&&this.particles.pop()}spawnParticles(e,i,s,a){var r=s*a*this.particlesDensity;for(let t=0;t<r;t++)this.particles.push({x:this.rand()*s+e,y:this.rand()*a+i,velY:(2*this.rand()-1)/30,velX:(2*this.rand()-1)/30,color:n.randomChoice(this.colors,this.rand)})}restart(){this.particles=[],this.width=this.ctx.canvas.width,this.height=this.ctx.canvas.height,this.spawnParticles(0,0,this.width,this.height)}resize(){var t=this.ctx.canvas.width-this.width,e=this.ctx.canvas.height-this.height;0<t&&this.spawnParticles(this.width,0,t,this.height),0<e&&this.spawnParticles(0,this.height,this.width,e),(0<t||0<e)&&this.spawnParticles(this.width,this.height,t,e),this.width=this.ctx.canvas.width,this.height=this.ctx.canvas.height;let i=this.width,s=this.height;this.particles=this.particles.filter(function(t){return!(t.x<0||t.x>i||t.y<0||t.y>s)})}mouseAction(t,e){"down"===e?(this.mouseDown=!0,this.mouseParticle.color=n.randomChoice(this.colors,this.rand)):"up"===e?this.mouseDown=!1:("down"===e||"move"===e&&this.mouseDown)&&(this.mouseParticle.x=t.x,this.mouseParticle.y=t.y)}getSettings(){return[{prop:"particlesDensity",type:"float",step:1e-4,min:1e-4,max:.002,toCall:"restart"},{prop:"fillTriangles",type:"bool"},{prop:"drawParticles",type:"bool"},{prop:"distanceThreshold",type:"int",min:0,max:200},{prop:"speed",type:"float",step:.1,min:-4,max:4},{prop:"addAParticle",type:"text",value:"<hold mouse button/touch>"},this.getSeedSettings()]}}e.exports=a},{"../animation":2,"../delaunay":31,"../utils":36}],16:[function(t,e,i){var s=t("../animation");let l=t("../utils");class a extends s{constructor(t,e,i,s,a=100,r=.07,n=.05,h=.5,o=1){super(t,e,i,s,"noisy lines","noisy-lines.js",`
...
Coded with no external dependencies, using only canvas API.
`),this.noiseXIncr=r,this.noiseYIncr=n,this.noiseRange=h,this.lines=a,this.speed=o,this.margin=.1}draw(){this.clear(),this.ctx.lineWidth=1,this.ctx.strokeStyle=this.colors[0];var t=this.ctx.canvas.width/2,e=this.ctx.canvas.height/2,i=t*(1-this.margin),s=e*(1-this.margin),a=2*s/(this.lines-1);this.ctx.translate(t,e);let r=.3*this.time;for(let t=0;t<this.lines;++t){var n=-s+t*a;let e=.3*this.time;r+=this.noiseYIncr*a/5,this.ctx.beginPath();for(let t=-i;t<=i;t+=5){e+=this.noiseXIncr;var h=l.remap(this.noise.perlin2(e,r),-1,1,1-this.noiseRange,1),o=t*h,h=n*h;t==-i?this.ctx.moveTo(o,h):this.ctx.lineTo(o,h)}this.ctx.stroke()}this.ctx.resetTransform()}getSettings(){return[{prop:"lines",type:"int",min:2,max:250},{prop:"noiseXIncr",type:"float",min:-.2,max:.2,step:.001},{prop:"noiseYIncr",type:"float",min:-.2,max:.2,step:.001},{prop:"noiseRange",type:"float",min:0,max:1,step:.01},{prop:"speed",type:"float",min:-8,max:8},this.getSeedSettings()]}}e.exports=a},{"../animation":2,"../utils":36}],17:[function(t,e,i){var s=t("../animation");let u=t("../utils");class a extends s{constructor(t,e,i,s,a=1e4,r="random",n=.03,h="random",o="random",l="random",c="random",d=!1,p=1,m=!1){super(t,e,i,s,"system of particles and attractors","particles-and-attractors.js",`
...
Coded with no external dependencies, using only canvas API.
`),this.depth=a,this.speed=r,this.contain=n,this.object=new h(this.depth,this.rand)}update(t){t=t/1e3*this.speed,this.object.update(t)}draw(){this.clear();let t=0;this.contain?(t=Math.min(this.ctx.canvas.width,this.ctx.canvas.height),this.ctx.translate((this.ctx.canvas.width-t)/2,(this.ctx.canvas.height-t)/2)):t=Math.max(this.ctx.canvas.width,this.ctx.canvas.height),this.ctx.lineWidth=1,this.ctx.strokeStyle=this.colors[0],this.ctx.fillStyle=this.colors[0],this.ctx.translate(t/2,t/2),this.object.draw(this.ctx,t),this.ctx.resetTransform()}updateDepth(){this.object.setDepth(this.depth)}getSettings(){return[{prop:"depth",type:"int",min:2,max:9,toCall:"updateDepth"},{prop:"speed",type:"float",step:.25,min:.5,max:8},{prop:"contain",type:"bool"},this.getSeedSettings()]}}e.exports=r},{"../animation":2,"../animation-queue":1,"../utils":36}],23:[function(t,e,i){var s=t("../grid-animation");let a=t("../utils");class r extends s{constructor(t,e,i,s,a=9,r=3,n=3){super(t,e,i,s,"rock-paper-scissors automata","rock-paper-scissors-automata.js",`
...
Coded with no external dependencies, using only canvas API.
`),this.shapeNames=["circles","points","lines","triangles","rectangles","pentagons","hexagons","heptagons","octagons"],this.vertices=this.assignIfRandom(r,d.randomInt(0,8)),this.updateName(),this.rotateShapes=n,this.shapes=a,this.distanceBase=.6,this.distanceRange=.2,this.sizeBase=.2,this.sizeRange=.12,this.scale=h,this.colorsScale=o,this.colorsShift=this.assignIfRandom(l,d.randomChoice([0,3.14])),this.rainbowColors=c}updateName(){this.name=this.shapeNames[this.vertices]+' "dancing" in a circle'}draw(){this.clear();var e=Math.max(this.ctx.canvas.width,this.ctx.canvas.height)/3*this.scale;this.ctx.translate(this.ctx.canvas.width/2,this.ctx.canvas.height/2);for(let t=0;t<this.shapes;++t){var i=t/this.shapes*2*Math.PI,s=(this.distanceBase+this.distanceRange*Math.cos(6*i+Math.cos(8*i+this.time/2)))*e,a=Math.cos(i)*s,s=Math.sin(i)*s,r=9*i-this.time,n=(this.sizeBase+this.sizeRange*Math.cos(r))*e,r=(Math.cos((r+this.colorsShift)*this.colorsScale)+1)/2;this.rainbowColors?this.ctx.strokeStyle=`hsl(${360*r}, 100%, 75%)`:this.ctx.strokeStyle=d.lerpColor(this.colorA,this.colorB,r),this.ctx.lineWidth=1,this.ctx.beginPath(),0===this.vertices&&d.pathCircle(this.ctx,a,s,n),1===this.vertices?d.pathCircle(this.ctx,a,s,1):d.pathPolygon(this.ctx,a,s,n,this.vertices,i*this.rotateShapes),this.ctx.stroke()}this.ctx.resetTransform()}getSettings(){return[{prop:"vertices",type:"int",min:0,max:8,toCall:"updateName"},{prop:"shapes",type:"int",min:0,max:2500},{prop:"rotateShapes",type:"bool"},{prop:"distanceRange",type:"float",min:0,max:this.distanceBase},{prop:"sizeRange",type:"float",min:0,max:this.sizeBase},{prop:"scale",type:"float",min:.05,max:1.95},{prop:"speed",type:"float",step:.1,min:-4,max:4},{prop:"colorsShift",type:"float",min:0,max:3.14},{prop:"colorsScale",type:"float",min:.05,max:2},{prop:"rainbowColors",name:'<i class="fa-solid fa-rainbow"></i> rainbow colors',type:"bool"}]}}e.exports=a},{"../animation":2,"../utils":36}],29:[function(t,e,i){var s=t("../animation");let l=t("../utils");class a extends s{constructor(t,e,i,s,a=4e3,r=2,n="random",h=!0,o=1){super(t,e,i,s,"spirograph","spirograph.js",`
