...
Uses only Canvas API.
Coded by me (Marek Wydmuch) in 2022.
`),this.shapeSides=[0,1,2,3,4,5,6,8],this.shapeNames=["circles","points","lines","triangles","rectangles","pentagons","hexagons","octagons"],this.sides=this.assignIfRandom(h,n.randomChoice(this.shapeSides)),this.updateName(),this.size=r,this.number=a}updateName(){this.name=this.shapeNames[this.shapeSides.indexOf(this.sides)]+" spinning in spiral"}draw(){this.clear(),this.ctx.translate(this.canvas.width/2,this.canvas.height/2),this.ctx.scale(this.scale,this.scale),this.ctx.strokeStyle=this.colors[0];for(let t=0;t<this.number;++t)this.ctx.rotate(Math.PI*(.001*this.time+1e-6*t)),this.ctx.beginPath(),0===this.sides&&n.pathCircle(this.ctx,t,t,this.size),1===this.sides?n.pathCircle(this.ctx,t,t,1):n.pathPolygon(this.ctx,t,t,this.size,this.sides,0),this.ctx.stroke();this.ctx.resetTransform()}getSettings(){return[{prop:"sides",type:"int",min:0,max:8,toCall:"updateName"},{prop:"number",type:"int",min:1,max:1024},{prop:"size",type:"int",min:1,max:128},{prop:"speed",icon:'<i class="fa-solid fa-gauge-high"></i>',type:"float",step:.1,min:-4,max:4}]}}e.exports=a},{"../animation":2,"../utils":42}],9:[function(t,e,i){var s=t("./game-of-life");let c=t("../utils");class a extends s{constructor(t,e,i,s,a=14,r=0,h=.4,n=!0,o=!0,l=!0,c=.75){super(t,e,i,s,a,r,h,l),this.name="isometric Conway's game of life",this.file="game-of-life-isometric.js",this.description=`
...
Uses only Canvas API.
Coded by me (Marek Wydmuch) in 2021.
`,this.fadeDeadCells=n,this.drawCellsGrid=o,this.gridSize=c,this.sqrt3=Math.sqrt(3),this.xShift=this.cellSize*this.sqrt3/2,this.yShift=this.cellSize/2,this.renderedGrid=null,this.prerenderCubes(),this.renderedCubes=[],this.usePrerenderElements=!0}prerenderCubes(){this.renderedCubes=[];var e=new OffscreenCanvas(4*this.xShift,4*this.yShift).getContext("2d");this.drawIsoCube(e,0,3*this.yShift,!0,!0,this.colors,0,this.cellSize),this.renderedCubes.push(e.canvas);for(let t=1;t<this.cellSize;++t)e=new OffscreenCanvas(4*this.xShift,4*this.yShift).getContext("2d"),this.drawIsoCube(e,0,3*this.yShift,!0,!0,this.colorsAlt,-t,this.cellSize),this.renderedCubes.push(e.canvas)}drawIsoCube(t,e,i,s,a,r,h,n){var o=n*this.sqrt3/2,n=n/2;h*=-1,t.strokeStyle=r[0],t.fillStyle=r[3],t.beginPath(),c.pathClosedShape(t,[[e,i-2*n+h],[e+o,i-n+h],[e+2*o,i-2*n+h],[e+o,i-3*n+h]]),t.fill(),t.stroke(),s&&(t.fillStyle=r[2],t.beginPath(),c.pathClosedShape(t,[[e,i],[e+o,i+n],[e+o,i-n+h],[e,i-2*n+h]]),t.fill(),t.stroke()),a&&(t.fillStyle=r[1],t.beginPath(),c.pathClosedShape(t,[[e+o,i+n],[e+2*o,i],[e+2*o,i-2*n+h],[e+o,i-n+h]]),t.fill(),t.stroke())}drawCube(t,e,i,s=0,a=0){var r=t*this.xShift-e*this.xShift,h=(t+e+1)*this.yShift;this.drawIsoCube(this.ctx,r,h,!this.isAlive(t,e+1),!this.isAlive(t+1,e),i,s,this.cellSize-2*a)}drawGrid(e){var i=this.gridHeight*-this.xShift,s=this.gridHeight*this.yShift,a=this.gridWidth*this.xShift,r=this.gridWidth*this.yShift,t=(-this.gridHeight+this.gridWidth)*this.xShift,h=(this.gridHeight+this.gridWidth)*this.yShift,n=this.colors[0];for(let t=0;t<this.gridHeight;++t){var o=t*-this.xShift,l=t*this.yShift;c.drawLine(e,o,l,o+a,l+r,1,n),c.drawLine(e,-o,l,i-o,l+s,1,n)}c.drawLine(e,0,0,a,r,3,n),c.drawLine(e,0,0,i,s,3,n),c.drawLine(e,i,s,t,h,3,n),c.drawLine(e,a,r,t,h,3,n)}drawPrerenderedCube(t,e,i){var s=t*this.xShift-e*this.xShift,t=(t+e+1)*this.yShift;this.ctx.drawImage(this.renderedCubes[i],s-+this.xShift,t-3*this.yShift)}mouseCellCord(t,e){}draw(){var t;this.clear(),this.drawCellsGrid&&(this.renderedGrid||((t=new OffscreenCanvas(this.canvas.width,this.canvas.height).getContext("2d")).translate(this.canvas.width/2,(1-this.gridSize)/2*this.canvas.height),this.drawGrid(t),this.renderedGrid=t.canvas),this.ctx.drawImage(this.renderedGrid,0,0)),this.ctx.translate(this.canvas.width/2,(1-this.gridSize)/2*this.canvas.height);for(let e=0;e<this.gridHeight;++e)for(let t=0;t<this.gridWidth;++t){var i=this.getVal(t,e);this.fadeDeadCells&&i>-(this.cellSize-2*this.cellBasePadding)?this.usePrerenderElements?this.drawPrerenderedCube(t,e,Math.max(0,-i)):this.drawCube(t,e,this.colorsAlt,Math.min(0,i),this.cellBasePadding):0<i&&this.drawPrerenderedCube(t,e,0)}this.ctx.resetTransform()}resize(){this.xShift=this.cellSize*this.sqrt3/2,this.yShift=this.cellSize/2;var t=Math.min(this.canvas.width,this.canvas.height),t=Math.ceil(this.gridSize*t/this.cellSize);this.resizeGrid(t,t),this.renderedGrid=null,this.prerenderCubes()}getSettings(){return[{prop:"loopGrid",type:"bool"},{prop:"fadeDeadCells",type:"bool"},{prop:"drawCellsGrid",type:"bool"},{prop:"gridSize",type:"float",step:.01,min:0,max:2.5,toCall:"resize"},{prop:"cellSize",type:"int",min:8,max:32,toCall:"resize"},{prop:"spawnProb",icon:'<i class="fa-solid fa-dice"></i>',type:"float",step:.01,min:0,max:1,toCall:"restart"},this.getSeedSettings()]}}e.exports=a},{"../utils":42,"./game-of-life":10}],10:[function(t,e,i){var s=t("../grid-animation");let d=t("../utils");class a extends s{constructor(t,e,i,s,a=12,r=1,h=.4,n=!0,o="random",l=5,c="size+color"){super(t,e,i,s,"Conway's game of life","game-of-life.js",`
...
`),this.particlesDensity=a,this.fillTriangles=r,this.drawParticles=h,this.distanceThreshold=n,this.width=0,this.height=0,this.particles=[],this.mouseDown=!1,this.mouseParticle={x:0,y:0,color:null}}drawTriangle(t,e,i){var s=Math.max(h.distVec2d(t,e),h.distVec2d(t,e),h.distVec2d(e,i));s>this.distanceThreshold||(this.ctx.beginPath(),h.pathClosedShape(this.ctx,[t,e,i]),e=h.lerpColorHex(t.color,this.bgColor,h.easeInSine(s/this.distanceThreshold)),this.fillTriangles?(this.ctx.fillStyle=e,this.ctx.fill()):(this.ctx.lineWidth=1,this.ctx.strokeStyle=e,this.ctx.stroke()))}update(t){super.update(t);for(var e of this.particles)e.x+=e.velX*t*this.speed,e.y+=e.velY*t*this.speed,(e.x<0||e.x>this.width)&&(e.velX*=-1),(e.y<0||e.y>this.height)&&(e.velY*=-1)}draw(){if(this.clear(),this.mouseDown&&this.particles.push(this.mouseParticle),0<this.particles.length){var e=r.triangulate(this.particles.map(function(t){return[t.x,t.y]}));for(let t=0;t<e.length;t+=3){var i=this.particles[e[t]],s=this.particles[e[t+1]],a=this.particles[e[t+2]];this.drawTriangle(i,s,a)}}if(this.drawParticles)for(var t of this.particles)h.fillCircle(this.ctx,t.x,t.y,2,t.color);this.mouseDown&&this.particles.pop()}spawnParticles(e,i,s,a){var r=s*a*this.particlesDensity;for(let t=0;t<r;t++)this.particles.push({x:this.rand()*s+e,y:this.rand()*a+i,velY:(2*this.rand()-1)/30,velX:(2*this.rand()-1)/30,color:h.randomChoice(this.colors,this.rand)})}restart(){this.particles=[],this.width=this.canvas.width,this.height=this.canvas.height,this.spawnParticles(0,0,this.width,this.height)}resize(){var t=this.canvas.width-this.width,e=this.canvas.height-this.height;0<t&&this.spawnParticles(this.width,0,t,this.height),0<e&&this.spawnParticles(0,this.height,this.width,e),(0<t||0<e)&&this.spawnParticles(this.width,this.height,t,e),this.width=this.canvas.width,this.height=this.canvas.height;let i=this.width,s=this.height;this.particles=this.particles.filter(function(t){return!(t.x<0||t.x>i||t.y<0||t.y>s)})}mouseAction(t,e){"down"===e?(this.mouseDown=!0,this.mouseParticle.color=h.randomChoice(this.colors,this.rand)):"up"===e?this.mouseDown=!1:("down"===e||"move"===e&&this.mouseDown)&&(this.mouseParticle.x=t.x,this.mouseParticle.y=t.y)}getSettings(){return[{prop:"particlesDensity",type:"float",step:1e-4,min:1e-4,max:.002,toCall:"restart"},{prop:"fillTriangles",type:"bool"},{prop:"drawParticles",type:"bool"},{prop:"distanceThreshold",type:"int",min:0,max:200},{prop:"speed",icon:'<i class="fa-solid fa-gauge-high"></i>',type:"float",step:.1,min:-4,max:4},{prop:"addAParticle",type:"text",value:"<hold mouse button/touch>"},this.getSeedSettings()]}}e.exports=a},{"../animation":2,"../delaunay":34,"../utils":42}],16:[function(t,e,i){var s=t("../animation");let l=t("../utils");class a extends s{constructor(t,e,i,s,a=100,r=.07,h=.05,n=.5,o=1){super(t,e,i,s,"noisy lines","noisy-lines.js",`
...
Uses only Canvas API.
Coded by me (Marek Wydmuch) in 2023.
`),this.noiseXIncr=r,this.noiseYIncr=h,this.noiseRange=n,this.lines=a,this.speed=o,this.margin=.1}draw(){this.clear(),this.ctx.lineWidth=1,this.ctx.strokeStyle=this.colors[0];var t=this.canvas.width/2,e=this.canvas.height/2,i=t*(1-this.margin),s=e*(1-this.margin),a=2*s/(this.lines-1);this.ctx.translate(t,e);let r=.3*this.time;for(let t=0;t<this.lines;++t){var h=-s+t*a;let e=.3*this.time;r+=this.noiseYIncr*a/5,this.ctx.beginPath();for(let t=-i;t<=i;t+=5){e+=this.noiseXIncr;var n=l.remap(this.noise.perlin2(e,r),-1,1,1-this.noiseRange,1),o=t*n,n=h*n;t==-i?this.ctx.moveTo(o,n):this.ctx.lineTo(o,n)}this.ctx.stroke()}this.ctx.resetTransform()}getSettings(){return[{prop:"lines",type:"int",min:2,max:250},{prop:"noiseXIncr",type:"float",min:-.2,max:.2,step:.001},{prop:"noiseYIncr",type:"float",min:-.2,max:.2,step:.001},{prop:"noiseRange",type:"float",min:0,max:1,step:.01},{prop:"speed",icon:'<i class="fa-solid fa-gauge-high"></i>',type:"float",min:-8,max:8},this.getSeedSettings()]}}e.exports=a},{"../animation":2,"../utils":42}],17:[function(t,e,i){var s=t("../animation");let u=t("../utils");class a extends s{constructor(t,e,i,s,a=1e4,r="random",h=.03,n="random",o="random",l="random",c="random",d=!1,p=1,m=!1){super(t,e,i,s,"system of particles and attractors","particles-and-attractors.js",`
...
`),this.pointsDensity=pointsDensity,this.drawPoints=drawPoints,this.maxPointsInNode=maxPointsInNode,this.noiseThreshold=noiseThreshold,this.drawLeafNodes=drawLeafNode,this.noiseScale=h,this.noiseSpeed=n,this.noisePos={x:0,y:0,z:0},this.noiseSpeed.x=this.assignIfRandom(this.noiseSpeed.x,o.round(o.randomRange(-1,1),1)),this.noiseSpeed.y=this.assignIfRandom(this.noiseSpeed.y,o.round(o.randomRange(-1,1),1)),this.minNodeSize=4,this.width=0,this.height=0,this.noisePos={x:0,y:0,z:0}}update(t){this.time+=t/1e3,++this.frame;let e=1,i=this.particlesSpeed;for(;1<i;)i/=2,e*=2;for(var s of this.particles)s.prevX=s.x,s.prevY=s.y;for(let t=0;t<e;++t)for(var a of this.particles){var r=2*this.noise.perlin2(a.x*this.noiseScale,a.y*this.noiseScale)*Math.PI/this.noiseScale;a.x+=Math.cos(r)*a.speed*i,a.y+=Math.sin(r)*a.speed*i}}draw(){this.fadeOut(this.fadingSpeed);for(var t of this.particles)o.drawLine(this.ctx,t.prevX,t.prevY,t.x,t.y,2*t.radius*this.particlesSize,t.color);this.imageData=this.ctx.getImageData(0,0,this.canvas.width,this.canvas.height)}restart(){super.restart(),this.clear(),this.particles=[],this.width=this.canvas.width,this.height=this.canvas.height,this.spawnParticles(0,0,this.width,this.height)}resize(){this.clear(),null!==this.imageData&&this.ctx.putImageData(this.imageData,0,0);var t=this.canvas.width-this.width,e=this.canvas.height-this.height;0<t&&this.spawnParticles(this.width,0,t,this.height),0<e&&this.spawnParticles(0,this.height,this.width,e),(0<t||0<e)&&this.spawnParticles(this.width,this.height,t,e),this.width=this.canvas.width,this.height=this.canvas.height;let i=this.width,s=this.height;this.particles=this.particles.filter(function(t){return!(t.x<0||t.x>i||t.y<0||t.y>s)})}updateColors(t,e,i){super.updateColors(t,e,i),this.restart()}getSettings(){return[{prop:"noiseScale",type:"float",step:.001,min:.001,max:.01,toCall:"restart"},{prop:"particlesDensity",type:"float",step:1e-4,min:1e-4,max:.005,toCall:"restart"},{prop:"particlesSpeed",type:"float",min:.25,max:32},{prop:"cellSize",type:"float",step:.1,min:1,max:4},{prop:"fadingSpeed",type:"float",step:1e-4,min:0,max:.01},this.getSeedSettings()]}}e.exports=a},{"../animation":2,"../utils":42}],21:[function(t,e,i){var s=t("../animation");let l=t("../utils");class a extends s{constructor(t,e,i,s,a=7e-4,r="random",h="random",n="random",o=0){super(t,e,i,s,"particles moving through Perlin noise","perlin-noise-particles.js",`
Particles moving through Perlin noise.

Uses only Canvas API.
Coded by me (Marek Wydmuch) in 2020.
`),this.particlesDensity=a,this.noiseScale=this.assignIfRandom(r,l.randomChoice([.001,.002,.003])),this.particlesSpeed=this.assignIfRandom(h,l.randomChoice([1,1.5,2])),this.particlesSize=this.assignIfRandom(n,l.randomChoice([1,1.5,2])),this.fadingSpeed=o,this.width=0,this.height=0,this.particles=[],this.imageData=null}update(t){var e,t=super.update(t);let i=1,s=this.particlesSpeed*t*1e3/30;for(;1<s;)s/=2,i*=2;for(e of this.particles)e.prevX=e.x,e.prevY=e.y;for(let t=0;t<i;++t)for(var a of this.particles){var r=2*this.noise.perlin2(a.x*this.noiseScale,a.y*this.noiseScale)*Math.PI/this.noiseScale;a.x+=Math.cos(r)*a.speed*s,a.y+=Math.sin(r)*a.speed*s}}draw(){this.fadeOut(this.fadingSpeed);for(var t of this.particles)l.drawLine(this.ctx,t.prevX,t.prevY,t.x,t.y,2*t.radius*this.particlesSize,t.color);this.imageData=this.ctx.getImageData(0,0,this.canvas.width,this.canvas.height)}spawnParticles(e,i,s,a){var r=s*a*this.particlesDensity;for(let t=0;t<r;t++){var h=this.rand()*s+e,n=this.rand()*a+i;this.particles.push({x:h,y:n,prevX:h,prevY:n,speed:.2*this.rand()+.1,radius:.5*this.rand()+.5,color:l.randomChoice(this.colors,this.rand)})}}restart(){super.restart(),this.clear(),this.particles=[],this.width=this.canvas.width,this.height=this.canvas.height,this.spawnParticles(0,0,this.width,this.height)}resize(){this.clear(),null!==this.imageData&&this.ctx.putImageData(this.imageData,0,0);var t=this.canvas.width-this.width,e=this.canvas.height-this.height;0<t&&this.spawnParticles(this.width,0,t,this.height),0<e&&this.spawnParticles(0,this.height,this.width,e),(0<t||0<e)&&this.spawnParticles(this.width,this.height,t,e),this.width=this.canvas.width,this.height=this.canvas.height;let i=this.width,s=this.height;this.particles=this.particles.filter(function(t){return!(t.x<0||t.x>i||t.y<0||t.y>s)})}updateColors(t,e,i){super.updateColors(t,e,i),this.restart()}getSettings(){return[{prop:"noiseScale",type:"float",step:.001,min:.001,max:.01,toCall:"restart"},{prop:"particlesDensity",type:"float",step:1e-4,min:1e-4,max:.005,toCall:"restart"},{prop:"particlesSpeed",type:"float",min:.25,max:32},{prop:"particlesSize",type:"float",step:.1,min:1,max:4},{prop:"fadingSpeed",type:"float",step:1e-4,min:0,max:.01},this.getSeedSettings()]}}e.exports=a},{"../animation":2,"../utils":42}],22:[function(t,e,i){var s=t("../grid-animation");let a=t("../utils");class r extends s{constructor(t,e,i,s,a=24,r=1,h=2){super(t,e,i,s,"Color Pong","pong.js",`
A variant of pong with two colors fighting for territory.

Uses only Canvas API.
Coded by me (Marek Wydmuch) in 2025.
`),this.cellSize=a,this.halfCellSize=a/2,this.speed=r,this.resetOnResize=!0,this.numBallsPerColor=h,this.balls=[]}newCellState(t,e,i,s){return t<i/2-1?1:0}resize(){super.resize(),this.halfCellSize=this.cellSize/2,this.balls=[];var e=this.canvas.width/2;for(let t=0;t<this.numBallsPerColor;t++){var i=a.randomRange(0,2*Math.PI,this.rand),s=a.randomRange(0,2*Math.PI,this.rand);this.balls.push({x:a.randomRange(this.cellSize,e-this.cellSize,this.rand),y:a.randomRange(this.cellSize,this.canvas.height-this.cellSize,this.rand),vx:Math.cos(i),vy:Math.sin(i),colorIndex:0}),this.balls.push({x:a.randomRange(e+this.cellSize,this.canvas.width-this.cellSize,this.rand),y:a.randomRange(this.cellSize,this.canvas.height-this.cellSize,this.rand),vx:Math.cos(s),vy:Math.sin(s),colorIndex:1})}}ballGridCollision(i,s,a){let r=!1,h=!1,n=new Set;var o,l,c,d,p=this.halfCellSize,m=Math.floor((s-p)/this.cellSize),u=Math.floor((s+p)/this.cellSize),t=Math.floor((a-p)/this.cellSize),g=Math.floor((a+p)/this.cellSize);for(let e=t;e<=g;e++)if(!(e<0||e>=this.gridHeight))for(let t=m;t<=u;t++)t<0||t>=this.gridWidth||(d=this.getIdx(t,e),this.grid[d]===i.colorIndex&&(n.has(d)||(this.grid[d]=1===i.colorIndex?0:1,n.add(d)),c=(d=t*this.cellSize)+this.cellSize,l=(o=e*this.cellSize)+this.cellSize,c=Math.min(s+p,c)-Math.max(s-p,d),d=Math.min(a+p,l)-Math.max(a-p,o),0<c)&&0<d&&(1e-4+c<d?r=!0:h=(1e-4+d<c||(r=!0),!0)));return{bounceX:r,bounceY:h}}updateBall(i,t){t=this.speed*(t/1e3)*this.cellSize*20;if(!(t<=0)){var e=Math.max(1,Math.ceil(t/this.halfCellSize)),s=t/e;for(let t=0;t<e;++t){let t=i.x+i.vx*s,e=i.y+i.vy*s;var{bounceX:a,bounceY:r}=this.ballGridCollision(i,t,e);a&&(i.vx=-i.vx,t=i.x+i.vx*s),r&&(i.vy=-i.vy,e=i.y+i.vy*s),t<this.halfCellSize?(t=this.halfCellSize,i.vx=Math.abs(i.vx)):t>=this.canvas.width-this.halfCellSize&&(t=this.canvas.width-this.halfCellSize,i.vx=-Math.abs(i.vx)),e<this.halfCellSize?(e=this.halfCellSize,i.vy=Math.abs(i.vy)):e>=this.canvas.height-this.halfCellSize&&(e=this.canvas.height-this.halfCellSize,i.vy=-Math.abs(i.vy)),i.x=t,i.y=e}}}update(t){super.update(t);for(var e of this.balls)this.updateBall(e,t)}draw(){this.clear();for(let e=0;e<this.gridHeight;++e)for(let t=0;t<this.gridWidth;++t){var i=this.getVal(t,e);this.ctx.fillStyle=1==i?this.mainColor:this.bgColor,this.ctx.fillRect(t*this.cellSize,e*this.cellSize,this.cellSize,this.cellSize)}for(var t of this.balls){var e=1===t.colorIndex?this.mainColor:this.bgColor;a.fillCircle(this.ctx,t.x,t.y,this.halfCellSize,e)}}updateColors(t,e,i){super.updateColors(t,e,i);for(var s of this.balls)0!==s.colorIndex&&1!==s.colorIndex&&(s.colorIndex=0)}getSettings(){return[{prop:"cellSize",type:"int",min:8,max:64,toCall:"restart"},{prop:"numBallsPerColor",name:"balls per color",type:"int",min:1,max:16,toCall:"restart"},{prop:"speed",type:"float",step:.1,min:.1,max:10},this.getSeedSettings()]}}e.exports=r},{"../grid-animation":35,"../utils":42}],23:[function(t,e,i){var s=t("../animation");let d=t("../utils");class a extends s{constructor(t,e,i,s,a=1,r=.4,h=!1,n=.002,o={x:"random",y:"random",z:1},l=.01,c=!0){super(t,e,i,s,"quadtree visualization","quadtree.js",`
...
Uses only Canvas API.
Coded by me (Marek Wydmuch) in 2022.
`),this.pointsDensity=r,this.drawPoints=h,this.maxPointsInNode=a,this.noiseThreshold=l,this.drawLeafNodes=c,this.noiseScale=n,this.noiseSpeed=o,this.noiseSpeed.x=this.assignIfRandom(this.noiseSpeed.x,d.round(d.randomRange(-1,1),1)),this.noiseSpeed.y=this.assignIfRandom(this.noiseSpeed.y,d.round(d.randomRange(-1,1),1)),this.minNodeSize=4,this.width=0,this.height=0,this.noisePos={x:0,y:0,z:0}}update(t){t=super.update(t);this.noisePos.x+=this.noiseSpeed.x*t*10,this.noisePos.y+=this.noiseSpeed.y*t*10,this.noisePos.z+=this.noiseSpeed.z*t*.05}generatePoints(){var i=[],s=1/this.pointsDensity,a=s/2,r=d.Mulberry32(this.seed);for(let e=a;e<this.width;e+=s)for(let t=a;t<this.height;t+=s){var h=this.noise.perlin3((e+this.noisePos.x)*this.noiseScale,(t+this.noisePos.y)*this.noiseScale,this.noisePos.z);Math.abs(h)<=this.noiseThreshold&&i.push({x:e-a+r()*s,y:t-a+r()*s})}return i}quadTree(t,e,i,s,a){var r=i/2,h=i/4;if(s.length<=this.maxPointsInNode||i<=this.minNodeSize)(i>this.minNodeSize||this.drawLeafNodes)&&this.ctx.strokeRect(t-r,e-r,i,i);else{var n,o=[],l=[],c=[],d=[];for(n of s)n.x<t&&n.y>=e?o.push(n):n.x>=t&&n.y>=e?l.push(n):n.x>=t&&n.y<e?d.push(n):n.x<t&&n.y<e&&c.push(n);this.quadTree(t+h,e+h,r,l,++a),this.quadTree(t+h,e-h,r,d,a),this.quadTree(t-h,e+h,r,o,a),this.quadTree(t-h,e-h,r,c,a)}}draw(){this.clear(),this.width=this.canvas.width,this.height=this.canvas.height;var t=Math.max(this.width,this.height),e=this.generatePoints();if(this.ctx.lineWidth=1,this.ctx.strokeStyle=this.colors[0],this.quadTree(this.width/2,this.height/2,t,e,0),this.drawPoints)if(this.ctx.fillStyle=this.colorsAlt[1],this.pointsDensity<.5)for(var i of e)d.fillCircle(this.ctx,i.x,i.y,2,this.colorsAlt[1]);else for(var s of e)this.ctx.fillRect(s.x,s.y,2,2)}restart(){this.noisePos={x:0,y:0,z:0},super.restart()}getSettings(){return[{prop:"maxPointsInNode",type:"int",min:1,max:16},{prop:"pointsDensity",type:"float",step:.1,min:.1,max:.7},{prop:"noiseScale",type:"float",step:1e-4,min:5e-4,max:.0125},{prop:"noiseSpeed.x",type:"float",step:.1,min:-10,max:10},{prop:"noiseSpeed.y",type:"float",step:.1,min:-10,max:10},{prop:"noiseSpeed.z",type:"float",step:.1,min:-10,max:10},{prop:"noiseThreshold",type:"float",min:0,max:.15,step:.001},{prop:"drawLeafNodes",type:"bool"},{prop:"drawPoints",type:"bool"},this.getSeedSettings()]}}e.exports=a},{"../animation":2,"../utils":42}],24:[function(t,e,i){var s=t("../animation");let h=t("../animation-queue"),c=t("../utils");class n{constructor(t,e,i,s,a){this.x=t,this.y=e,this.squaresPerSide=i,this.squares=i*i,this.depth=s,this.rand=a,this.createChildren()}createChildren(){this.animQueue=new h,this.children=[],this.positions=[],this.freePosIdx=this.squares-1,this.prevFreePosIdx=this.squares-1;for(let e=0;e<this.squaresPerSide;++e)for(let t=0;t<this.squaresPerSide;++t){var i=t*this.squaresPerSide+e,s=e/this.squaresPerSide,a=t/this.squaresPerSide,r=[];0<=e-1&&r.push(i-1),e+1<this.squaresPerSide&&r.push(i+1),0<=t-1&&r.push(i-this.squaresPerSide),t+1<this.squaresPerSide&&r.push(i+this.squaresPerSide),this.positions[i]={x:s,y:a,neighbors:r},e==this.squaresPerSide-1&&t==this.squaresPerSide-1||0==this.depth||(r=new n(s,a,this.squaresPerSide,this.depth-1,this.rand),this.positions[i].child=r,this.children.push(r))}}update(t){if(0!==this.children.length){for(var e of this.children)e.update(t);for(;0<this.animQueue.step(t);){let i=this.positions[this.freePosIdx],t=this.prevFreePosIdx;for(;t===this.prevFreePosIdx;)t=c.randomChoice(i.neighbors,this.rand);let s=this.positions[t],a=s.child,r=this.depth/2,h=(s.child=null,i.child=a,this.prevFreePosIdx=this.freePosIdx,this.freePosIdx=t,c.easeInOutSine);this.animQueue.push(function(t){var e=Math.min(t,r)/r;return a.x=c.lerp(s.x,i.x,h(e)),a.y=c.lerp(s.y,i.y,h(e)),t-r})}}}draw(t,e,i,s){if(s||i||t.strokeRect(0,0,e,e),0===this.children.length)i&&(s?t.fillRect(2,2,e-2,e-2):t.strokeRect(4,4,e-4,e-4));else for(var a of this.children)t.save(),t.translate(a.x*e,a.y*e),a.draw(t,e/this.squaresPerSide,i,s),t.restore()}}class a extends s{constructor(t,e,i,s,a=5,r=3,h=1,n="padded stroke",o=1,l=!1){super(t,e,i,s,"recursive squares","recursion-squares.js",`
...
Uses only Canvas API.
Coded by me (Marek Wydmuch) in 2021.
`),this.shapeNames=["circles","points","lines","triangles","rectangles","pentagons","hexagons","heptagons","octagons"],this.vertices=this.assignIfRandom(r,d.randomInt(0,8)),this.updateName(),this.rotateShapes=h,this.shapes=a,this.distanceBase=.6,this.distanceRange=.2,this.sizeBase=.2,this.sizeRange=.12,this.scale=n,this.colorsScale=o,this.colorsShift=this.assignIfRandom(l,d.randomChoice([0,3.14])),this.rainbowColors=c}updateName(){this.name=this.shapeNames[this.vertices]+' "dancing" in a circle'}draw(){this.clear();var e=Math.max(this.canvas.width,this.canvas.height)/3*this.scale;this.ctx.translate(this.canvas.width/2,this.canvas.height/2);for(let t=0;t<this.shapes;++t){var i=t/this.shapes*2*Math.PI,s=(this.distanceBase+this.distanceRange*Math.cos(6*i+Math.cos(8*i+this.time/2)))*e,a=Math.cos(i)*s,s=Math.sin(i)*s,r=9*i-this.time,h=(this.sizeBase+this.sizeRange*Math.cos(r))*e,r=(Math.cos((r+this.colorsShift)*this.colorsScale)+1)/2;this.rainbowColors?this.ctx.strokeStyle=`hsl(${360*r}, 100%, 75%)`:this.ctx.strokeStyle=d.lerpColorHex(this.mainColor,this.secColor,r),this.ctx.lineWidth=1,this.ctx.beginPath(),0===this.vertices&&d.pathCircle(this.ctx,a,s,h),1===this.vertices?d.pathCircle(this.ctx,a,s,1):d.pathPolygon(this.ctx,a,s,h,this.vertices,i*this.rotateShapes),this.ctx.stroke()}this.ctx.resetTransform()}getSettings(){return[{prop:"vertices",icon:'<i class="fa-solid fa-shapes"></i>',name:"vertices per shape",type:"int",min:0,max:8,toCall:"updateName"},{prop:"shapes",name:"number of shapes",type:"int",min:0,max:2500},{prop:"rotateShapes",icon:'<i class="fa-solid fa-rotate"></i>',type:"bool"},{prop:"distanceRange",type:"float",min:0,max:this.distanceBase},{prop:"sizeRange",type:"float",min:0,max:this.sizeBase},{prop:"scale",icon:'<i class="fa-solid fa-maximize"></i>',type:"float",min:.05,max:1.95},{prop:"speed",icon:'<i class="fa-solid fa-gauge-high"></i>',type:"float",step:.1,min:-4,max:4},{prop:"colorsShift",type:"float",min:0,max:3.14},{prop:"colorsScale",type:"float",min:.05,max:2},{prop:"rainbowColors",icon:'<i class="fa-solid fa-rainbow"></i>',type:"bool"}]}}e.exports=a},{"../animation":2,"../utils":42}],31:[function(t,e,i){var s=t("../animation");let c=t("../utils");class a extends s{constructor(t,e,i,s,a=4e3,r=2,h="random",n=!0,o=1,l=!1){super(t,e,i,s,"spirograph","spirograph.js",`
...
Coded by me (Marek Wydmuch) in 2024.
`)}}e.exports=s},{"../threejs-shader-animation":41}],40:[function(t,e,i){t=t("./animation");class s extends t{constructor(t,e,i,s,a="",r="",h="",n="random"){super(t,e,i,s,a,r,h,n,null),this.renderer=new THREE.WebGLRenderer({antialias:!0,canvas:t}),this.renderer.setSize(t.width,t.height),this.scene=new THREE.Scene,this.scene.background=new THREE.Color(s),this.camera=new THREE.PerspectiveCamera(75,t.width/t.height,1,1e3)}update(t){super.update(t)}draw(){this.renderer.render(this.scene,this.camera)}resize(){super.resize();var t=this.canvas.width,e=this.canvas.height;this.renderer.setSize(t,e),this.camera.aspect=t/e,this.camera.updateProjectionMatrix()}updateColors(t,e,i){super.updateColors(t,e,i),this.scene.background=new THREE.Color(i)}getCodeUrl(){return"https://github.com/mwydmuch/mwydmuch.github.io/blob/master/js/threejs-animations"+this.file}}e.exports=s},{"./animation":2}],41:[function(t,e,i){t=t("./threejs-animation");class s extends t{constructor(t,e,i,s,a,r="",h="",n="",o="random"){super(t,e,i,s,r,h,n,o,"webgl");this.camera=new THREE.OrthographicCamera(-1,1,1,-1,.1,10),this.camera.position.z=1,this.scale=1,this.uMainColor=new THREE.Color(this.mainColor),this.uSecColor=new THREE.Color(this.secColor),this.uBgColor=new THREE.Color(this.bgColor),this.shaderMaterial=new THREE.ShaderMaterial({vertexShader:`
            varying vec2 vUv;
